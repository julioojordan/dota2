...
<html lang="en">
  ...
  <head>
    ...
    <title>Dota 2 Heroes Recomendation</title>
<!--
SOFTY PINKO
...
ww
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                            <img src="<?php echo base_url() . 'assets/images/logo.png' ?>" alt="Softy Pinko"/>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                        <h1>We provide the best <strong>strategy</strong><br>to WIN your <strong>MMR Games</strong></h1>
                        <p>Created By Parad1se</p>
                        <a href="#features" class="main-button-slider">Start Heroes Recomendation</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- <section class="section home-feature">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-3" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <i><img src="assets/images/antimage.png" alt="" width="200" height="130"></i>
            ...
            <div class="container">
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <fieldset>
                            <input name="keyword" type="text" class="form-control" id="keyword" placeholder="Find your Hero">
                        </fieldset>
                    </div>
                </div>
                <!-- ***** Mini Box Start ***** -->
                <div class="row" id="all_heroes">
                    <?php 
                        foreach($heroes as $row) :
                    ?>
                        <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                            <a href="#" class="mini-box">
                                <i><img src="<?php echo base_url().'assets/images/'?><?php echo $row['image']?>" alt="" width="90" height="55"></i>
                                <strong><?php echo $row['name']?></strong>
                            </a>
                        </div>
                    <?php endforeach; ?>
                </div>
                <span id="searched_heroes">
                    
                </span>
                <div class="row" id="searched_heroes" style="display: none">
                </div>
                <!-- ***** Mini Box End ***** -->
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            var all_heroes =  document.getElementById("all_heroes");
            var searched_heroes =  document.getElementById("searched_heroes");
            $("#keyword").keyup(function(){
                if($("#keyword").val().length>1){
                    all_heroes.style.display = "none";
                    searched_heroes.style.display = "block";
                    $.ajax({
                        url:"<?php echo base_url();?>index.php/LandingPage/search_heroes",
                        method : "POST",
                        data: 'keyword='+$("#keyword").val(),
                        dataType : 'json',
                        success:function(data){
                            searched_heroes.innerHTML = '';
                            console.log(data);
                            if (data != false){
                                $.each(data, function(key,val){
                                    searched_heroes.innerHTML += "<div class='col-lg-2 col-md-3 col-sm-6 col-6'><a href='#' class='mini-box'><i><img src='<?php echo base_url().'assets/images/'?>"+val.image+"' alt=' width='90' height='55'></i><strong>"+val.name+"</strong></a> </div>"
                                });
                            } else{ //data tidak ditemukan
                                searched_heroes.innerHTML = "<br><p style='text-align: center; font-weight: bold;'> No Heroes Found ! </p>"
                            }
                        }
                    });
                }else{
                    all_heroes.style.display = "block";
                    searched_heroes.style.display = "none";
                }
            });
        });
    </script>
